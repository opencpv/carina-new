  ...
  return (
    <FullscreenLayout className="flex flex-col">
      <nav className="px-10 py-5 flex items-center justify-between border-b">
        <CaAppLogo />
        <button
          className="py-3 h-fit px-10 bg-primary hover:bg-black text-white rounded-lg"
          onClick={() => {
            window.location.href = "/dashboard/hospital/claim";
          }}
        >
          Create Claim
        </button>
                    ...
                    <td className="py-4 px-6 border-b border-gray-200">
                      {!claim.submitted && (
                        <button
                          ...
                          onClick={() => {
                            window.location.href = `/dashboard/hospital/claim/${claim.id}`;
                          }}
                        >
                          Edit
                        </button>
